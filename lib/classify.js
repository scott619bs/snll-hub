...
// ─── AI CLASSIFY VIA CLAUDE ───────────────────────────────────────────────────
export async function aiClassify(apiKey, input, inputType, gameDate, opponent, adminNotes = '') {
...
${adminNotes ? `Admin correction notes: ${adminNotes}` : ''}
